 ...
 * under the License.
 */
package com.wci.android.ballistaibeacondemo.bluetooth.ibeacon;
...
import com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.service.IBeaconService;
import com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.service.RegionData;
import com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.service.StartRMData;
import com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.simulator.BeaconSimulator;
...
public class IBeaconManager {
    ...
    /**
     * The default duration in milliseconds of the bluetooth_old scan cycle
     */
    public static final long DEFAULT_FOREGROUND_SCAN_PERIOD = 1100;
    /**
     * The default duration in milliseconds spent not scanning between each bluetooth_old scan cycle
     */
    public static final long DEFAULT_FOREGROUND_BETWEEN_SCAN_PERIOD = 0;
    /**
     * The default duration in milliseconds of the bluetooth_old scan cycle when no ranging/monitoring clients are in the foreground
     */
    public static final long DEFAULT_BACKGROUND_SCAN_PERIOD = 10000;
    /**
     * The default duration in milliseconds spent not scanning between each bluetooth_old scan cycle when no ranging/monitoring clients are in the foreground
     */
     ...
     * <code>Activity</code> or <code>Service</code> must implement the <code>IBeaconConsumer</code> interface so
     ...
     *
     * @param notifier
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.RangeNotifier
     */
     ...
     * @param notifier
     * @see MonitorNotifier
     * @see #startMonitoringBeaconsInRegion(com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.Region region)
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.Region
     */
     ...
     *
     * @param region
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.IBeaconManager#setRangeNotifier(com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.RangeNotifier)
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.IBeaconManager#stopRangingBeaconsInRegion(com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.Region region)
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.RangeNotifier
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.Region
     */
    @TargetApi(18)
     ...
     *
     * @param region
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.IBeaconManager#setMonitorNotifier(MonitorNotifier)
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.IBeaconManager#stopMonitoringBeaconsInRegion(com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.Region region)
     * @see MonitorNotifier
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.Region
     */
    @TargetApi(18)
     ...
     * @param region
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.IBeaconManager#setMonitorNotifier(MonitorNotifier)
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.IBeaconManager#startMonitoringBeaconsInRegion(com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.Region region)
     * @see MonitorNotifier
     * @see com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.Region
     */
    @TargetApi(18)
    ...
    private boolean isInBackground() {
        ...
        synchronized (consumers) {
            for (IBeaconConsumer consumer : consumers.keySet()) {
                ...
                if (debug)
                    Log.d(TAG, "Consumer " + consumer + " isInBackground=" + consumers.get(consumer).isInBackground);
            }
        }
