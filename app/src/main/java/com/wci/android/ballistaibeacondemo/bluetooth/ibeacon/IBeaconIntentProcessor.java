...
import com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.service.MonitoringData;
import com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.service.RangingData;
...
public class IBeaconIntentProcessor extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (rangingData != null) {
            ...
            Collection<IBeacon> iBeacons = com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.service.IBeaconData.fromIBeaconDatas(rangingData.getIBeacons());
            if (notifier != null) {
