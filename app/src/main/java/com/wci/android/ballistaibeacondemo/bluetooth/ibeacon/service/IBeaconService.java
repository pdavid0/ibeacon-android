 ...
 * under the License.
 */
package com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.service;
...
import com.wci.android.ballistaibeacondemo.BuildConfig;
import com.wci.android.ballistaibeacondemo.bluetooth.BluetoothCrashResolver;
...
public class IBeaconService extends Service {
            ...
            if (service != null) {
                switch (msg.what) {
                    case MSG_START_RANGING:
                        ...
                        service.startRangingBeaconsInRegion(startRMData.getRegionData(), new com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.service.Callback(startRMData.getCallbackPackageName()));
                    ...
                    case MSG_START_MONITORING:
                        ...
                        service.startMonitoringBeaconsInRegion(startRMData.getRegionData(), new com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.service.Callback(startRMData.getCallbackPackageName()));
                        service.setScanPeriods(startRMData.getScanPeriod(), startRMData.getBetweenScanPeriod());
                        break;
    ...
    private void scanLeDevice(final Boolean enable) {
        ...
        if (getBluetoothAdapter() == null) {
            Log.e(TAG, "No bluetooth_old adapter.  iBeaconService cannot scan.");
        ...
        if (enable) {
            ...
            if (millisecondsUntilStart > 0) {
                if (IBeaconManager.debug)
                    Log.d(TAG, "Waiting to start next bluetooth_old scan for another " + millisecondsUntilStart + " milliseconds");
            ...
            if (scanning == false || scanningPaused == true) {
                ...
                try {
                    ...
                    Log.e("TAG", "Exception starting bluetooth_old scan.  Perhaps bluetooth_old is disabled or unavailable?");
                }
            } else {
