...
import com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.client.IBeaconDataFactory;
import com.wci.android.ballistaibeacondemo.bluetooth.ibeacon.client.NullIBeaconDataFactory;
...
public class IBeacon {
        ...
        if (accuracy == null) {
            ...
            if (runningAverageRssi != null) {
                ...
                if (IBeaconManager.debug)
                    Log.d(TAG, "Not using running average RSSI because it is null");
            }
    ...
    /**
     * Construct an iBeacon from a Bluetooth LE packet collected by Android's Bluetooth APIs,
     * including the raw bluetooth_old device info
     *
     * @param scanData The actual packet bytes
     * @param rssi     The measured signal strength of the packet
     * @param device   The bluetooth_old device that was detected
     * @return An instance of an <code>IBeacon</code>
     */
    @TargetApi(5)
